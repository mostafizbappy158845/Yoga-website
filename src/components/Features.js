  ...
  return (
    ...
    lg:mt-[130px]'>
      <div className="container mx-auto">
        ...
        lg:h-[622px] w-full flex justify-center items-center rounded-md -mt-[150px]
        mb-[28px] lg:mb-20'
          data-aos='fade-up'
        ...
        >
          {/* video play button */}
          <div onClick={() => setIsOpen(!isOpen)} className='text-6xl lg:text-[120px] cursor-pointer hover:scale-110
        ...
        <div className='flex flex-col lg:flex-row lg:gap-x-8'>
          ...
          data-aos='fade-left'
          >
            <p className='max-w-[360px] mb-[18px] lg:mb-[38px]'>Practise anywhere, anytime. Explore a new way to exercise
              and learn more about yourself. We are providing the best.
            </p>
