...
const Hero = () => {
  return (
    <section id='home' className='min-h-[618px] lg:min-h-[815px] pt-9 lg:bg-circle lg:bg-no-repeat lg:bg-right-top'>
        ...
        <div className='flex flex-col items-center lg:flex-row lg:items-start pt-32'>
          <div className='flex-1 lg:mt-12'>
            ...
            >Yoga is a way of life, rather than a chore.
              Counteract of stresses of modern life by becoming more mindful and
              compassionate.
            </p>
